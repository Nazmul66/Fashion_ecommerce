                    ...
                    <div class="intro-slider intro-slider-1 owl-carousel owl-simple owl-light owl-nav-inside" data-toggle="owl" data-owl-options='{
                        ...
                        <div class="intro-slide">
                            <figure class="slide-image">
                                <picture>
                                    <source media="(max-width: 480px)" srcset="{{ asset('public/frontend/assets/images/slider/slide-1-480w.jpg') }}">
                                    <img src="{{ asset('public/frontend/assets/images/slider/slide-1.jpg') }}" alt="Image Desc">
                                </picture>
                        ...
                        <div class="intro-slide">
                            <figure class="slide-image">
                                <picture>
                                    <source media="(max-width: 480px)" srcset="{{ asset('public/frontend/assets/images/slider/slide-2-480w.jpg') }}">
                                    <img src="{{ asset('public/frontend/assets/images/slider/slide-2.jpg/') }}" alt="Image Desc">
                                </picture>
                            </figure>
                        ...
                        <div class="intro-slide">
                            <figure class="slide-image">
                                <picture>
                                    <source media="(max-width: 480px)" srcset="{{ asset('public/frontend/assets/images/slider/slide-3-480w.jpg') }}">
                                    <img src="{{ asset('public/frontend/assets/images/slider/slide-3.jpg') }}" alt="Image Desc">
                                </picture>
                            </figure<!-- End .slide-image -->
                    ...
                    <div class="row row-sm">
                        <div class="col-md-6 col-lg-12">
                            <div class="banner banner-display">
                                <a href="#">
                                    <img src="{{ asset('public/frontend/assets/images/banners/home/intro/banner-1.jpg') }}" alt="Banner">
                                </a>
                        ...
                        <div class="col-md-6 col-lg-12">
                            <div class="banner banner-display mb-0">
                                <a href="#">
                                    <img src="{{ asset('public/frontend/assets/images/banners/home/intro/banner-2.jpg') }}" alt="Banner">
                                </a>
            ...
            <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                ...
                <div class="product product-11 text-center">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-1-1.jpg') }}" alt="Product image" class="product-image">
                            <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-1-2.jpg') }}" alt="Product image" class="product-image-hover">
                        </a>
                ...
                <div class="product product-11 text-center">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-2-1.jpg') }}" alt="Product image" class="product-image">
                            <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-2-2.jpg') }}" alt="Product image" class="product-image-hover">
                        </a>
                ...
                <div class="product product-11 text-center">
                    <figure class="product-media">
                        ...
                        <a href="product.html">
                            <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-3-1.jpg') }}" alt="Product image" class="product-image">
                            <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-3-2.jpg') }}" alt="Product image" class="product-image-hover">
                        </a>
                ...
                <div class="product product-11 text-center">
                    <figure class="product-media">
                        ...
                        <a href="product.html">
                            <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-4-1.jpg') }}" alt="Product image" class="product-image">
                            <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-4-2.jpg') }}" alt="Product image" class="product-image-hover">
                        </a>
                ...
                <div class="product product-11 text-center">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-5-1.jpg') }}" alt="Product image" class="product-image">
                            <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-5-2.jpg') }}" alt="Product image" class="product-image-hover">
                        </a>
                ...
                <div class="product product-11 text-center">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-6-1.jpg') }}" alt="Product image" class="product-image">
                            <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-6-2.jpg') }}" alt="Product image" class="product-image-hover">
                        </a>
    ...
    <div class="row">
        <div class="col-6 col-lg-4">
            <div class="banner banner-display banner-link-anim">
                <a href="#">
                    <img src="{{ asset('public/frontend/assets/images/banners/home/banner-1.jpg') }}" alt="Banner">
                </a>
        ...
        <div class="col-6 col-lg-4 order-lg-last">
            <div class="banner banner-display banner-link-anim">
                <a href="#">
                    <img src="{{ asset('public/frontend/assets/images/banners/home/banner-4.jpg') }}" alt="Banner">
                </a>
        ...
        <div class="col-sm-12 col-lg-4 banners-sm">
            <div class="row">
                <div class="banner banner-display banner-link-anim col-lg-12 col-6">
                    <a href="#">
                        <img src="{{ asset('public/frontend/assets/images/banners/home/banner-2.jpg') }}" alt="Banner">
                    </a>
                ...
                <div class="banner banner-display banner-link-anim col-lg-12 col-6">
                    <a href="#">
                        <img src="{{ asset('public/frontend/assets/images/banners/home/banner-3.jpg') }}" alt="Banner">
                    </a>
                ...
                <div class="row justify-content-center">
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product product-11 mt-v3 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-12-1.jpg') }}" alt="Product image" class="product-image">
                                    <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-12-2.jpg') }}" alt="Product image" class="product-image-hover">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product product-11 mt-v3 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-10-1.jpg') }}" alt="Product image" class="product-image">
                                    <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-10-2.jpg') }}" alt="Product image" class="product-image-hover">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product product-11 mt-v3 text-center">
                            <figure class="product-media">
                                <span class="product-label label-new">NEW</span>
                                <a href="product.html">
                                    <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-9-1.jpg') }}" alt="Product image" class="product-image">
                                    <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-9-2.jpg') }}" alt="Product image" class="product-image-hover">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product product-11 mt-v3 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-8-1.jpg') }}" alt="Product image" class="product-image">
                                    <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-8-2.jpg') }}" alt="Product image" class="product-image-hover">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product product-11 mt-v3 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-11-1.jpg') }}" alt="Product image" class="product-image">
                                    <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-11-2.jpg') }}" alt="Product image" class="product-image-hover">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product product-11 mt-v3 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-13-1.jpg') }}" alt="Product image" class="product-image">
                                    <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-13-2.jpg') }}" alt="Product image" class="product-image-hover">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product product-11 mt-v3 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-14-1.jpg') }}" alt="Product image" class="product-image">
                                    <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-14-2.jpg') }}" alt="Product image" class="product-image-hover">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product product-11 mt-v3 text-center">
                            <figure class="product-media">
                                <span class="product-label label-new">NEW</span>
                                <a href="product.html">
                                    <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-16-1.jpg') }}" alt="Product image" class="product-image">
                                    <img src="{{ asset('public/frontend/assets/images/demos/demo-2/products/product-16-2.jpg') }}" alt="Product image" class="product-image-hover">
                                </a>
...
<div class="cta cta-display bg-image pt-4 pb-4" style="background-image: url({{ asset('public/frontend/assets/images/backgrounds/cta/bg-6.jpg') }});">
    <div class="container">
        <div class="row justify-content-center">
        ...
        <div class="owl-carousel owl-simple carousel-with-shadow" data-toggle="owl"
            ...
            <article class="entry entry-display">
                <figure class="entry-media">
                    <a href="single.html">
                        <img src="{{ asset('public/frontend/assets/images/blog/home/post-1.jpg') }}" alt="image desc">
                    </a>
            ...
            <article class="entry entry-display">
                <figure class="entry-media">
                    <a href="single.html">
                        <img src="{{ asset('public/frontend/assets/images/blog/home/post-2.jpg') }}" alt="image desc">
                    </a>
                </figure><!-- End .entry-media -->
            ...
            <article class="entry entry-display">
                <figure class="entry-media">
                    <a href="single.html">
                        <img src="{{ asset('public/frontend/assets/images/blog/home/post-3.jpg') }}" alt="image desc">
                    </a>
                </figure><!-- End .entry-media -->
